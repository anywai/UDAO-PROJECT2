...
describe("Platform Treasury Contract - Coaching", function () {
  ...
  it("Should return coaching list of token", async function () {
    ...
    expect((await contractPlatformTreasury.getCoachings(0)).toString()).to.be.eql("0,1");
  });
  ...
  it("Should fail to buy a coaching if coaching is not enabled", async function () {
    ...
    await contractUDAO
      .connect(contentBuyer)
      .approve(contractPlatformTreasury.address, ethers.utils.parseEther("999999999999.0"));
    await expect(contractPlatformTreasury.connect(contentBuyer).buyCoaching(0)).to.revertedWith(
  ...
  it("Should fail to buy coaching if buyer is banned", async function () {
    ...
    await expect(contractPlatformTreasury.connect(contentBuyer).buyCoaching(0)).to.revertedWith("You are banned");
  });
  ...
  it("Should fail to buy coaching if instructer is banned", async function () {
    ...
    await expect(contractPlatformTreasury.connect(contentBuyer).buyCoaching(0)).to.revertedWith("Instructor is banned");
  });
  ...
  it("Should finalize coaching as learner", async function () {
    ...
    expect(await contractPlatformTreasury.instructorBalance(contentCreator.address)).to.be.eql(
      ethers.utils.parseEther("1.906")
    );
  });
  ...
  it("Should fail coaching as instructor if deadline is not met", async function () {
    ...
    await expect(contractPlatformTreasury.connect(contentCreator).finalizeCoaching(0)).to.revertedWith(
  ...
  it("Should fail to finalize coaching if neither learner or instructor", async function () {
    ...
    await expect(contractPlatformTreasury.connect(foundation).finalizeCoaching(0)).to.be.revertedWith(
  ...
  it("Should fail to finalize coaching if coaching does not exist", async function () {
    ...
    await expect(contractPlatformTreasury.connect(contentBuyer).finalizeCoaching(1)).to.be.revertedWith(
      "Coaching id doesn't exist"
    );
  });
  ...
  it("Should delay coaching deadline if learner", async function () {
    ...
    const tx = await contractPlatformTreasury.connect(contentBuyer).buyCoaching(0);
    const result = await tx.wait();
    const timestamp = (await ethers.provider.getBlock(result.logs[0].blockNumber)).timestamp;
    const resultTxEvent = result.events.find((e) => e.event == "CoachingBought");
    ...
    await network.provider.send("evm_mine"); //
    await expect(contractPlatformTreasury.connect(contentBuyer).delayDeadline(0))
  ...
  it("Should delay coaching deadline if coach", async function () {
    ...
    await network.provider.send("evm_increaseTime", [60 * 60 * 24 * 29]);
    await network.provider.send("evm_mine"); //
    await expect(contractPlatformTreasury.connect(contentCreator).delayDeadline(0))
      .to.emit(contractPlatformTreasury, "DeadlineDelayed")
      .withArgs(0, parseInt(timestamp) + 37 * 24 * 60 * 60);
  });
  ...
  it("Should fail to delay coaching deadline if not last 3 days", async function () {
    ...
    // Check if returned learner address is the same as the buyer address
    expect(coachingStruct.learner).to.equal(contentBuyer.address);
    await expect(contractPlatformTreasury.connect(contentCreator).delayDeadline(0)).to.revertedWith(
  ...
  it("Should fail to delay coaching deadline if sender is neither coach nor learner", async function () {
    ...
    // Check if returned learner address is the same as the buyer address
    expect(coachingStruct.learner).to.equal(contentBuyer.address);
    await expect(contractPlatformTreasury.connect(jurorMember).delayDeadline(0)).to.revertedWith(
  ...
  it("Should fail force payment for coaching if not admin role", async function () {
    ...
    // Check if returned learner address is the same as the buyer address
    expect(coachingStruct.learner).to.equal(contentBuyer.address);
    await expect(contractPlatformTreasury.connect(validator1).forcedPayment(0)).to.revertedWith(
  ...
  it("Should fail to refund payment for coaching if not coach", async function () {
    ...
    // Check if returned learner address is the same as the buyer address
    expect(coachingStruct.learner).to.equal(contentBuyer.address);
    await expect(contractPlatformTreasury.connect(contentBuyer).refund(0)).to.revertedWith("Your are not the coach");
  });
  ...
  it("Should refund payment for coaching as admin", async function () {
    ...
    // Check if returned learner address is the same as the buyer address
    expect(coachingStruct.learner).to.equal(contentBuyer.address);
    await expect(contractPlatformTreasury.connect(foundation).forcedRefundAdmin(0))
      .to.emit(contractPlatformTreasury, "Refund")
      .withArgs(0, contentBuyer.address, ethers.utils.parseEther("2"));
  });
  ...
  it("Should fail refund payment for coaching as admin if not admin", async function () {
    ...
    // Check if returned learner address is the same as the buyer address
    expect(coachingStruct.learner).to.equal(contentBuyer.address);
    await expect(contractPlatformTreasury.connect(validator1).forcedRefundAdmin(0)).to.revertedWith(
  ...
  it("Should fail refund payment for coaching as admin if not refundable", async function () {
    ...
    // Check if returned learner address is the same as the buyer address
    expect(coachingStruct.learner).to.equal(contentBuyer.address);
    await expect(contractPlatformTreasury.connect(foundation).forcedRefundAdmin(0)).to.revertedWith(
      "Coaching is not refundable"
    );
  });
});
