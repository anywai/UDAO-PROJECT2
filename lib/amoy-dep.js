// Definition: Deployment script for Amoy Network.
// Usage: hardhat run lib/amoy-dep.js --network amoy-testnet
// Note: diffrence from mum-dep.js is that console logs are colored.

const hardhat = require("hardhat");
const { ethers } = hardhat;

async function main() {
  // Console log functions and colors.
  // Main colors
  const colorRed = "\u001b[31m";
  ...
  console.log("--------------------------------------------------------------------");
  console.log(colorRed, "DEPLOYING TO 'AMOY-TESTNET'", colorReset);
  ...
  console.log(colorCyan, "contractUDAO deployed at: ", contractUDAO.address, colorReset);
  console.log(colorMagenta, `Verifying contractUDAO on Polygonscan...`, colorReset);
  try {
  ...
  console.log(colorCyan, "contractRoleManager deployed at: ", contractRoleManager.address, colorReset);
  console.log(colorMagenta, `Verifying contractRoleManager on Polygonscan...`, colorReset);
  ...
  console.log(colorCyan, "contractGovernanceTreasury deployed at: ", contractGovernanceTreasury.address, colorReset);
  console.log(colorMagenta, `Verifying contractGovernanceTreasury on Polygonscan...`, colorReset);
  try {
    await hre.run(`verify:verify`, {
  ...
  console.log(colorCyan, "contractUDAOContent deployed at: ", contractUDAOContent.address, colorReset);
  console.log(colorMagenta, `Verifying contractUDAOContent on Polygonscan...`, colorReset);
  try {
    await hre.run(`verify:verify`, {
  ...
  console.log(colorCyan, "contractUDAOCertificate deployed at: ", contractUDAOCertificate.address, colorReset);
  console.log(colorMagenta, `Verifying contractUDAOCertificate on Polygonscan...`, colorReset);
  try {
    await hre.run(`verify:verify`, {
  ...
  console.log(colorCyan, "contractVoucherVerifier deployed at: ", contractVoucherVerifier.address, colorReset);
  console.log(colorMagenta, `Verifying contractVoucherVerifier on Polygonscan...`, colorReset);
  try {
    await hre.run(`verify:verify`, {
  ...
  console.log(colorCyan, "contractPlatformTreasury deployed at: ", contractPlatformTreasury.address, colorReset);
  console.log(colorMagenta, `Verifying contractPlatformTreasury on Polygonscan...`, colorReset);
  try {
    await hre.run(`verify:verify`, {
  ...
  console.log(colorCyan, "contractContractManager deployed at: ", contractContractManager.address, colorReset);
  console.log(colorMagenta, `Verifying contractContractManager on Polygonscan...`, colorReset);
  try {
    await hre.run(`verify:verify`, {
  ...
  console.log(colorCyan, "contractSupervision deployed at: ", contractSupervision.address, colorReset);
  console.log(colorMagenta, `Verifying contractSupervision on Polygonscan...`, colorReset);
  try {
    await hre.run(`verify:verify`, {
  ...
  console.log(colorCyan, "contractVesting deployed at: ", contractVesting.address, colorReset);
  console.log(colorMagenta, `Verifying contractVesting on Polygonscan...`, colorReset);
  try {
    await hre.run(`verify:verify`, {
  ...
  consoleLog_emptySpace();
  console.log("--------------------------------------------------------------------");
  console.log(colorRed, "POST-DEPLOYMENT:", colorReset);
  ...
  // GRANT ROLES
  console.log(colorRed, "Project Roles are Granting...", colorReset);
  ...
  console.log(colorRed, "Addresses in project are updating...", colorReset);
  ...
  console.log(colorRed, "Foundation address in project are setting...", colorReset);
  ...
  console.log(colorBlue, "!KYC and BAN is deactivated for easy integration!", colorReset);
  /*
  ...
  */
  ...
  console.log(colorRed, "Returning ownership of RoleManager backend to foundation...", colorReset);
  ...
  consoleLog_emptySpace();
  console.log("--------------------------------------------------------------------");
  console.log(colorRed, "DEPLOYMENT COMPLETE'", colorReset);
