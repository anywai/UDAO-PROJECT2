...
const SIGNING_DOMAIN_NAME = "UDAOCertMinter";
const SIGNING_DOMAIN_VERSION = "1";

/**
 * JSDoc typedefs.
 *
 * @typedef {object} CertificateVoucher
...
class LazyUDAOCertMinter {
  ...
  /**
   * Creates a new CertificateVoucher object and signs it using this LazyMinter's signing key.
   *
   * @param {ethers.BigNumber | number} tokenId the id of the un-minted NFT
   * @param {string} uri the metadata URI to associate with this NFT
   * @param {ethers.utils.getAddress | address} redeemer the address of the learner
