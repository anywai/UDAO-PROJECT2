...
function getVoucherHelpers(opts = {}) {
  ...
  return {
    create: new CreateCourseVoucherHelper({ contractAddress, signer }),
    update: new UpdateCourseVoucherHelper({ contractAddress, signer }),
    buy: new BuyCourseVoucherHelper({ contractAddress, signer }),
    refund: new RefundCourseVoucherHelper({ contractAddress, signer }),
    refundByOwner: new RefundCourseByOwnerAndCourseIdVoucherHelper({ contractAddress, signer }),
    withdraw: new WithdrawVoucherHelper({ contractAddress, signer }),
  };
}
