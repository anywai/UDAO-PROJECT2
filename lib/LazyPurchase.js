 ...
 * JSDoc typedefs.
 *
 * @typedef {object} ContentPurchaseVoucher
...
class LazyPurchase {
  ...
  /**
   * Creates a new ContentPurchaseVoucher object and signs it using this LazyMinter's signing key.
   *
   ...
   *
   * @returns {ContentPurchaseVoucher}
   */
  async createVoucher(tokenId, purchasedParts, priceToPay, validUntil, redeemer) {
    const voucher = {
      tokenId,
      purchasedParts,
      priceToPay,
